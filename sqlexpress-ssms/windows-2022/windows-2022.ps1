...
Write-Stage "install: Microsoft SQL Server 2022 Express with SQL Server Management Studio 22 on win2022"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
if (-not $mgSecretFilesInit.ContainsKey('C:\credentials.txt')) {
    $mgCredHeader = @(
        "==================================================================",
        "  Microsoft SQL Server 2022 Express with SQL Server Management Studio 22 - deployment credentials",
...
Set-Status 'Installing Microsoft SQL Server 2022 Express with SQL Server Management Studio 22 and dependencies (this can take a few minutes)...'
...
function Get-FileWithRetry {
    param([string]$Url, [string]$OutFile, [int]$Attempts = 4)
...
if (-not $existing) {
    ...
    $sqlExe = Join-Path $stage 'SQLEXPR_x64_ENU.exe'
    Get-FileWithRetry -Url 'https://download.microsoft.com/download/3/8/d/38de7036-2433-4207-8eae-06e247e17b25/SQLEXPR_x64_ENU.exe' -OutFile $sqlExe
    ...
    if ($p.ExitCode -ne 0) { throw "SQLEXPR self-extract failed with exit code $($p.ExitCode)" }

    $setup = Join-Path $extractDir 'setup.exe'
    if (-not (Test-Path $setup)) { throw "setup.exe not found after extract at $setup" }

    Write-Output "running SQL Server 2022 Express setup (fully silent)"
    $sqlArgs = @(
        '/Q',
        '/ACTION=Install',
        '/FEATURES=SQLENGINE',
    ...
    $ip = Start-Process -FilePath $setup -ArgumentList $sqlArgs -Wait -PassThru
    if ($ip.ExitCode -ne 0 -and $ip.ExitCode -ne 3010) {
        throw "SQL Server setup failed with exit code $($ip.ExitCode)"
    }
    Write-Output "SQL Server Express installed (exit code $($ip.ExitCode))"
} else {
    Write-Output "SQL Server Express instance already present; skipping engine install"
}

# Pin static TCP port 1433 (disable dynamic ports)
$tcpKey = 'HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQLServer\SuperSocketNetLib\Tcp\IPAll'
if (Test-Path $tcpKey) {
    Set-ItemProperty -Path $tcpKey -Name 'TcpPort' -Value '1433'
    Set-ItemProperty -Path $tcpKey -Name 'TcpDynamicPorts' -Value ''
    Write-Output "pinned SQL Server TCP port to 1433"
}

# Ensure service runs now and on every boot, then restart to apply TCP settings
...
if (-not (Test-Path $ssmsExe)) {
    New-Item -ItemType Directory -Force -Path $stage | Out-Null
    $ssmsBootstrap = Join-Path $stage 'vs_SSMS.exe'
    Get-FileWithRetry -Url 'https://aka.ms/ssms/22/release/vs_SSMS.exe' -OutFile $ssmsBootstrap

    Write-Output "installing SSMS 22 (this can take several minutes / ~1GB)"
    Start-Process -FilePath $ssmsBootstrap -ArgumentList '--quiet', '--norestart', '--wait' -PassThru | Out-Null

    $deadline = (Get-Date).AddMinutes(30)
    while (-not (Test-Path $ssmsExe) -and (Get-Date) -lt $deadline) {
        Start-Sleep -Seconds 20
    }
    if (Test-Path $ssmsExe) {
        Write-Output "SSMS 22 installed"
    } else {
        Write-Output "WARNING: SSMS 22 did not appear within timeout; it may still be finishing in the background"
    }
} else {
    Write-Output "SSMS 22 already installed"
}

# All-users desktop shortcut for SSMS
if (Test-Path $ssmsExe) {
    ...
    $sc.Description = 'Microsoft SQL Server Management Studio 22'
    $sc.Save()
    Write-Output "created SSMS shortcut on the all-users desktop"
}

# Append connection details to the credentials document (never overwrite)
$ipAddr = (Get-NetIPAddress -AddressFamily IPv4 | Where-Object { $_.IPAddress -ne '127.0.0.1' -and $_.PrefixOrigin -ne 'WellKnown' } | Select-Object -First 1).IPAddress
Add-Content -Path 'C:\credentials.txt' -Value ''
Add-Content -Path 'C:\credentials.txt' -Value '--- SQL Server 2022 Express connection ---'
Add-Content -Path 'C:\credentials.txt' -Value "Server        : $ipAddr,1433"
Add-Content -Path 'C:\credentials.txt' -Value 'Instance      : SQLEXPRESS'
Add-Content -Path 'C:\credentials.txt' -Value 'Login         : sa'
Add-Content -Path 'C:\credentials.txt' -Value "Password       : (see 'Sa Password' above)"
Add-Content -Path 'C:\credentials.txt' -Value "Connection str : Server=tcp:$ipAddr,1433;User ID=sa;Password=<see above>;Encrypt=False"
Add-Content -Path 'C:\credentials.txt' -Value 'NOTE: SQL Server Management Studio 22 may need one reboot before it launches from the desktop shortcut. The SQL Server engine itself does NOT require a reboot.'

# Clean up staged installers
Remove-Item -Recurse -Force $stage -ErrorAction SilentlyContinue
Write-Output "SQL Server 2022 Express deployment complete; listening on TCP 1433"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
