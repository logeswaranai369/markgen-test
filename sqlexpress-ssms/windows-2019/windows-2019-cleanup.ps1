...
Write-Host "  SUCCESS  Your Marketplace App (Microsoft SQL Server 2022 Express + SQL Server Management Studio 22) has been deployed successfully!" -ForegroundColor Green
Write-Host "================================================================================" -ForegroundColor Green
Write-Host ""
