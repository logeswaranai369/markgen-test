...
Write-Stage "install: RabbitMQ (Community) with Management plugin on win2022"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
if (-not $mgSecretFilesInit.ContainsKey('C:\credentials.txt')) {
    $mgCredHeader = @(
        "==================================================================",
        "  RabbitMQ (Community) with Management plugin - deployment credentials",
...
Set-Status 'Installing RabbitMQ (Community) with Management plugin and dependencies (this can take a few minutes)...'
...
function Get-File {
    ...
    for ($i = 1; $i -le 4; $i++) {
        try {
            Write-Output "downloading (attempt $i): $Url"
...
$erlHome = 'C:\Program Files\erl'
$rmqRoot = 'C:\Program Files\RabbitMQ Server'
$rmqHome = Join-Path $rmqRoot 'rabbitmq_server-4.3.5'
$rmqBase = 'C:\ProgramData\RabbitMQ'
$svcName = 'RabbitMQ'

# ---- Erlang/OTP (hard prerequisite, installed BEFORE RabbitMQ) ----
if (-not (Test-Path (Join-Path $erlHome 'bin\erl.exe'))) {
    $erlExe = Join-Path $stage 'otp_win64_28.5.0.5.exe'
    Get-File -Url 'https://github.com/erlang/otp/releases/download/OTP-28.5.0.5/otp_win64_28.5.0.5.exe' -Dest $erlExe
    Write-Output "installing Erlang/OTP silently to $erlHome"
    # NSIS: /S = silent, /D= must be LAST and unquoted -> pass as ONE argument string
    $p = Start-Process -FilePath $erlExe -ArgumentList "/S /D=$erlHome" -Wait -PassThru
    if ($p.ExitCode -notin 0, 3010) { throw "Erlang installer failed: $($p.ExitCode)" }
    if (-not (Test-Path (Join-Path $erlHome 'bin\erl.exe'))) { throw "erl.exe missing after Erlang install" }
} else {
    Write-Output "Erlang already present at $erlHome"
}

# Machine + process env for the RabbitMQ service and CLI tools
...
# Create the service data base dir BEFORE install so the service (SYSTEM) has a real workdir
New-Item -ItemType Directory -Force -Path $rmqBase | Out-Null

# ---- RabbitMQ Server from the portable ZIP (NOT the NSIS .exe, which hangs under SYSTEM) ----
if (-not (Test-Path (Join-Path $rmqHome 'sbin\rabbitmqctl.bat'))) {
    $rmqZip = Join-Path $stage 'rabbitmq-server-windows-4.3.5.zip'
    Get-File -Url 'https://github.com/rabbitmq/rabbitmq-server/releases/download/v4.3.5/rabbitmq-server-windows-4.3.5.zip' -Dest $rmqZip
    ...
    if (-not (Test-Path (Join-Path $rmqHome 'sbin\rabbitmqctl.bat'))) { throw "rabbitmqctl.bat missing after extract" }
} else {
    Write-Output "RabbitMQ already extracted at $rmqHome"
}

$sbin       = Join-Path $rmqHome 'sbin'
...
# ---- Register + start the Windows service ourselves (deterministic under SYSTEM) ----
if (-not (Get-Service -Name $svcName -ErrorAction SilentlyContinue)) {
    Write-Output "registering RabbitMQ Windows service"
    $rc = Invoke-Tool -Exe $svcBat -ToolArgs @('install')
    if ($rc -ne 0) { throw "rabbitmq-service install failed: $rc" }
}
if (-not (Get-Service -Name $svcName -ErrorAction SilentlyContinue)) { throw "$svcName service not found after install" }

Set-Service -Name $svcName -StartupType Automatic
if ((Get-Service -Name $svcName).Status -ne 'Running') {
    Start-Service -Name $svcName
}
if ((Get-Service -Name $svcName).Status -ne 'Running') { throw "$svcName failed to reach Running" }
Write-Output "RabbitMQ service is Running"

# Wait for the node to be fully booted before issuing CLI commands
$rc = Invoke-Tool -Exe $ctlBat -ToolArgs @('await_startup')
if ($rc -ne 0) { Write-Output "await_startup returned $rc (continuing)" }

# ---- Enable the management plugin ----
$rc = Invoke-Tool -Exe $pluginsBat -ToolArgs @('enable', 'rabbitmq_management')
if ($rc -ne 0) { throw "enabling rabbitmq_management plugin failed: $rc" }

# ---- Create the admin user (idempotent) ----
$adminUser = 'rabbitadmin'
$existsRc = Invoke-Tool -Exe $ctlBat -ToolArgs @('list_users')
$rc = Invoke-Tool -Exe $ctlBat -ToolArgs @('add_user', $adminUser, $rabbitmq_admin_password)
if ($rc -ne 0) {
    Write-Output "add_user returned $rc (user may already exist); resetting password"
    $rc = Invoke-Tool -Exe $ctlBat -ToolArgs @('change_password', $adminUser, $rabbitmq_admin_password)
    if ($rc -ne 0) { throw "could not set password for $adminUser" }
}
$rc = Invoke-Tool -Exe $ctlBat -ToolArgs @('set_user_tags', $adminUser, 'administrator')
if ($rc -ne 0) { throw "set_user_tags failed: $rc" }
$rc = Invoke-Tool -Exe $ctlBat -ToolArgs @('set_permissions', '-p', '/', $adminUser, '.*', '.*', '.*')
if ($rc -ne 0) { throw "set_permissions failed: $rc" }
Write-Output "admin user '$adminUser' configured with administrator tag and full permissions on /"

# ---- Firewall: AMQP 5672 and Management 15672 ----
foreach ($fw in @(@{Name='RabbitMQ AMQP 5672'; Port=5672}, @{Name='RabbitMQ Management 15672'; Port=15672})) {
    if (-not (Get-NetFirewallRule -DisplayName $fw.Name -ErrorAction SilentlyContinue)) {
        ...
        Write-Output "firewall rule added: $($fw.Name)"
    }
}

# ---- Verify listeners are up (non-CIM socket probe, never a WMI loop) ----
foreach ($port in 5672, 15672) {
    $ok = $false
    for ($i = 0; $i -lt 30; $i++) {
        if (Test-NetConnection -ComputerName '127.0.0.1' -Port $port -WarningAction SilentlyContinue -InformationLevel Quiet) { $ok = $true; break }
        Start-Sleep -Seconds 3
    }
    if (-not $ok) { throw "RabbitMQ port $port is not listening" }
    Write-Output "port $port is listening"
}

# ---- Append connection info to the scaffold-owned credentials file (APPEND, never overwrite) ----
...
Add-Content -Path 'C:\credentials.txt' -Value ""
Add-Content -Path 'C:\credentials.txt' -Value "=== RabbitMQ (Community) ==="
Add-Content -Path 'C:\credentials.txt' -Value "Management UI    : http://${ip}:15672/"
Add-Content -Path 'C:\credentials.txt' -Value "Admin Username   : rabbitadmin"
Add-Content -Path 'C:\credentials.txt' -Value "Admin Password   : (see 'Rabbitmq Admin Password' above)"
Add-Content -Path 'C:\credentials.txt' -Value "AMQP Endpoint    : amqp://${ip}:5672/"
Add-Content -Path 'C:\credentials.txt' -Value "NOTE: the built-in 'guest' account is restricted to loopback only."

# ---- Clean up staging dir ----
Remove-Item -Recurse -Force $stage -ErrorAction SilentlyContinue
Write-Output "RabbitMQ 4.3.5 with management plugin deployed successfully"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
