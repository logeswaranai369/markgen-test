...
Write-Stage "install: IIS+ASP.NET on win2019"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
Set-Status 'Installing IIS+ASP.NET and dependencies (this can take a few minutes)...'

# ----- BEGIN app-specific tasks (LLM-generated from AppSpec) -----
$needed = 'Web-Server', 'Web-Mgmt-Tools', 'Web-Mgmt-Console', 'Web-Asp-Net45', 'Web-Net-Ext45', 'Web-ISAPI-Ext', 'Web-ISAPI-Filter'
$missing = $needed | Where-Object { -not (Get-WindowsFeature -Name $_).Installed }
if ($missing) {
    Write-Output "installing IIS/ASP.NET features: $($missing -join ', ')"
    Install-WindowsFeature -Name $missing -IncludeManagementTools | Out-Null
} else {
    Write-Output "all required IIS/ASP.NET features already installed"
}

# Verify the management console (inetmgr) is actually present - -IncludeManagementTools alone is unreliable.
$inetMgr = 'C:\Windows\System32\inetsrv\InetMgr.exe'
if (-not (Test-Path $inetMgr)) {
    Write-Output "InetMgr.exe missing after feature install; re-installing Web-Mgmt-Console"
    Install-WindowsFeature -Name Web-Mgmt-Console, Web-Mgmt-Tools | Out-Null
}

# Register ASP.NET 4.x with IIS explicitly (idempotent) so .aspx pages execute.
$aspnetRegIis = Join-Path $env:WINDIR 'Microsoft.NET\Framework64\v4.0.30319\aspnet_regiis.exe'
if (-not (Test-Path $aspnetRegIis)) {
    $aspnetRegIis = Join-Path $env:WINDIR 'Microsoft.NET\Framework\v4.0.30319\aspnet_regiis.exe'
}
if (Test-Path $aspnetRegIis) {
    Write-Output "registering ASP.NET 4.x with IIS"
    & $aspnetRegIis -iru | Out-Null
}

# Deploy a placeholder static page and a dynamic .aspx page to prove ASP.NET executes.
New-Item -ItemType Directory -Force -Path 'C:\inetpub\wwwroot' | Out-Null
Set-Content -Path 'C:\inetpub\wwwroot\index.html' -Value '<h1>Deployed by Markgen</h1>'
Set-Content -Path 'C:\inetpub\wwwroot\test.aspx' -Value '<%@ Page Language="C#" %><h1>ASP.NET <%= System.Environment.Version %> OK</h1>'
Write-Output "deployed placeholder index.html and test.aspx"

# Ensure the inbound HTTP firewall rule is enabled.
...
if ($httpRule) {
    ...
    Write-Output "enabled built-in HTTP (TCP 80) firewall rule"
} elseif (-not (Get-NetFirewallRule -DisplayName 'Markgen HTTP 80' -ErrorAction SilentlyContinue)) {
    New-NetFirewallRule -DisplayName 'Markgen HTTP 80' -Direction Inbound -Protocol TCP -LocalPort 80 -Action Allow | Out-Null
    Write-Output "created inbound firewall rule for TCP 80"
}

# Create an IIS Manager shortcut on the ALL-USERS (Public) desktop - first-boot has no per-user profile.
...
# Ensure the web publishing service runs now and on every boot.
if ((Get-Service W3SVC).Status -ne 'Running') { Start-Service W3SVC }
Set-Service W3SVC -StartupType Automatic
Write-Output "W3SVC running; IIS serving ASP.NET 4.7 on port 80"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
