...
Write-Stage "install: MySQL Community Server on win2025"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
$stage = 'C:\Temp\mysql-stage'
$basedir = 'C:\Program Files\MySQL\mysql-8.4.11-winx64'
$dataDir = 'C:\ProgramData\MySQL\data'
$myIni   = 'C:\ProgramData\MySQL\my.ini'
$mysqld  = Join-Path $basedir 'bin\mysqld.exe'
$mysql   = Join-Path $basedir 'bin\mysql.exe'

# --- (1) VC++ 2015-2022 x64 redist (unconditional; installer is idempotent) ---
...
for ($i = 1; $i -le 4 -and -not $ok; $i++) {
    try {
        Invoke-WebRequest -UseBasicParsing -Uri 'https://aka.ms/vs/17/release/vc_redist.x64.exe' -OutFile $vc -TimeoutSec 300
        $ok = $true
    } catch {
...
if (-not $ok) { throw "failed to download vc_redist.x64.exe" }
...
# --- (2)/(3) download + extract MySQL ZIP (only if not already present) ---
if (-not (Test-Path $mysqld)) {
    $zip = Join-Path $stage 'mysql-8.4.11-winx64.zip'
    Write-Output "downloading MySQL 8.4.11 ZIP archive"
    $ok = $false
    for ($i = 1; $i -le 4 -and -not $ok; $i++) {
        try {
            Invoke-WebRequest -UseBasicParsing -Uri 'https://cdn.mysql.com/Downloads/MySQL-8.4/mysql-8.4.11-winx64.zip' -OutFile $zip -TimeoutSec 1200
            $ok = $true
        } catch {
    ...
    if (-not $ok) { throw "failed to download MySQL ZIP" }
    ...
    Expand-Archive -Path $zip -DestinationPath 'C:\Program Files\MySQL' -Force
}
if (-not (Test-Path $mysqld)) { throw "mysqld.exe not found at $mysqld after extraction" }

# --- (4) data dir + my.ini (ASCII / no BOM, forward slashes) ---
...
mysqlx-port=33060
"@
[System.IO.File]::WriteAllText($myIni, $iniContent)
Write-Output "wrote my.ini to $myIni"

# --- (5) initialize data directory (only if empty) ---
$dataItems = Get-ChildItem -Path $dataDir -ErrorAction SilentlyContinue
if (-not $dataItems) {
    Write-Output "initializing MySQL data directory (insecure)"
    $p = Start-Process -FilePath $mysqld -ArgumentList "--defaults-file=`"$myIni`"","--initialize-insecure" -Wait -PassThru -NoNewWindow
    if ($p.ExitCode -ne 0) { throw "mysqld --initialize-insecure failed: $($p.ExitCode)" }
}

# --- (6) register the Windows service (only if not present) ---
$svc = Get-Service -Name 'MySQL' -ErrorAction SilentlyContinue
if (-not $svc) {
    Write-Output "registering MySQL Windows service"
    $p = Start-Process -FilePath $mysqld -ArgumentList "--install","MySQL","--defaults-file=`"$myIni`"" -Wait -PassThru -NoNewWindow
    if ($p.ExitCode -ne 0) { throw "mysqld --install failed: $($p.ExitCode)" }
}

# --- (7) start + set automatic, wait for Running ---
...
if ((Get-Service -Name 'MySQL').Status -ne 'Running') { throw "MySQL service failed to reach Running" }
Write-Output "MySQL service is Running"

# wait for the port to accept connections (non-CIM probe)
$deadline = (Get-Date).AddSeconds(120)
$listening = $false
while ((Get-Date) -lt $deadline -and -not $listening) {
    if (netstat -ano | Select-String ':3306\s') { $listening = $true } else { Start-Sleep -Seconds 3 }
}
if (-not $listening) { throw "mysqld is not listening on port 3306" }
Write-Output "mysqld listening on 3306"

# --- (8) set root password + allow remote root ---
$sql = @"
...
FLUSH PRIVILEGES;
"@
$sqlFile = Join-Path $stage 'init.sql'
[System.IO.File]::WriteAllText($sqlFile, $sql)

$prevEAP = $ErrorActionPreference
$ErrorActionPreference = 'Continue'
Write-Output "configuring root password and remote access"
& $mysql --host=127.0.0.1 --port=3306 -u root --connect-expired-password -e "source $sqlFile" 2>&1 | ForEach-Object { Write-Output $_ }
$rc = $LASTEXITCODE
$ErrorActionPreference = $prevEAP
if ($rc -ne 0) { throw "mysql root configuration failed (exit $rc)" }
Write-Output "root password configured and remote root enabled"
...
if (-not (Get-NetFirewallRule -DisplayName 'MySQL 3306' -ErrorAction SilentlyContinue)) {
    ...
    Write-Output "opened inbound TCP 3306"
}

# append connection info to the credentials file (never overwrite)
Add-Content -Path 'C:\credentials.txt' -Value ""
Add-Content -Path 'C:\credentials.txt' -Value "MySQL Community Server 8.4.11"
Add-Content -Path 'C:\credentials.txt' -Value "  Port: 3306 (X protocol 33060)"
Add-Content -Path 'C:\credentials.txt' -Value "  Username: root (remote root@'%' enabled)"
Add-Content -Path 'C:\credentials.txt' -Value "  Password: see 'Mysql Root Password' above"

# cleanup staging
Remove-Item -Recurse -Force $stage -ErrorAction SilentlyContinue
Write-Output "MySQL 8.4.11 install complete"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
