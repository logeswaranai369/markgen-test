...
Write-Stage "install: MariaDB Server (Community) on win2019"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
$staging = 'C:\Temp\mariadb-install'
...
# --- Visual C++ 2015-2022 x64 Redistributable (install unconditionally; installer is idempotent) ---
$vcPath = Join-Path $staging 'vc_redist.x64.exe'
Get-File -Url 'https://aka.ms/vs/17/release/vc_redist.x64.exe' -Dest $vcPath
Write-Output "installing Visual C++ 2015-2022 x64 Redistributable"
$vc = Start-Process -FilePath $vcPath -ArgumentList '/install', '/quiet', '/norestart' -Wait -PassThru
if ($vc.ExitCode -notin 0, 3010) { throw "vc_redist install failed: $($vc.ExitCode)" }

# --- MariaDB Server 11.8.9 MSI ---
$msiPath = Join-Path $staging 'mariadb-11.8.9-winx64.msi'
$msiLog  = Join-Path $staging 'mariadb-install.log'
...
if ((Get-Service -Name 'MariaDB' -ErrorAction SilentlyContinue)) {
    ...
    Get-File -Url 'https://downloads.mariadb.org/rest-api/mariadb/11.8.9/mariadb-11.8.9-winx64.msi' -Dest $msiPath
    Write-Output "installing MariaDB Server 11.8.9 (silent)"
    $args = @(
        '/i', "`"$msiPath`"",
        '/qn',
        '/l*v', "`"$msiLog`"",
    ...
    if ($p.ExitCode -notin 0, 3010) {
        Write-Output "MariaDB MSI failed with exit code $($p.ExitCode); dumping log tail:"
        if (Test-Path $msiLog) {
            Get-Content $msiLog -Tail 60 | Where-Object { $_ -match 'Return value 3|error status|2711|note: 1:' } | ForEach-Object { Write-Output $_ }
            Get-Content $msiLog -Tail 20 | ForEach-Object { Write-Output $_ }
        }
...
Start-Sleep -Seconds 5
if ((Get-Service -Name 'MariaDB').Status -ne 'Running') {
    throw "MariaDB service failed to reach Running state"
}
Write-Output "MariaDB service is Running"

# --- Firewall: allow inbound TCP 3306 ---
if (-not (Get-NetFirewallRule -DisplayName 'MariaDB (TCP 3306)' -ErrorAction SilentlyContinue)) {
    New-NetFirewallRule -DisplayName 'MariaDB (TCP 3306)' -Direction Inbound -Protocol TCP -LocalPort 3306 -Action Allow -Profile Any | Out-Null
    Write-Output "created firewall rule for TCP 3306"
}

# --- Verify the port is listening (non-CIM socket probe) ---
$listening = $false
for ($i = 1; $i -le 30; $i++) {
...
$vmIp = (Get-NetIPAddress -AddressFamily IPv4 -ErrorAction SilentlyContinue | Where-Object { $_.IPAddress -notlike '127.*' -and $_.IPAddress -notlike '169.254.*' -and $_.PrefixOrigin -ne 'WellKnown' } | Select-Object -First 1).IPAddress
Add-Content -Path 'C:\credentials.txt' -Value ""
Add-Content -Path 'C:\credentials.txt' -Value "--- MariaDB Server 11.8.9 connection ---"
Add-Content -Path 'C:\credentials.txt' -Value "Host        : $vmIp"
Add-Content -Path 'C:\credentials.txt' -Value "Port        : 3306"
Add-Content -Path 'C:\credentials.txt' -Value "Username    : root"
Add-Content -Path 'C:\credentials.txt' -Value "Password    : (see 'Mariadb Root Password' above)"
Add-Content -Path 'C:\credentials.txt' -Value "CLI example : `"C:\Program Files\MariaDB 11.8\bin\mysql.exe`" -h $vmIp -P 3306 -u root -p"

# --- Clean up staging (idempotent; re-run re-downloads) ---
Remove-Item -Recurse -Force $staging -ErrorAction SilentlyContinue

Write-Output "MariaDB Server 11.8.9 install complete"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
