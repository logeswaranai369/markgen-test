...
Write-Stage "install: MariaDB Server (community) on win2022"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
function Get-RemoteFile {
    ...
    while ($true) {
        $attempt++
        try {
            Write-Output "downloading (attempt $attempt): $Url"
            ...
            if ($attempt -ge 4) { throw "failed to download $Url after $attempt attempts" }
            Start-Sleep -Seconds 10
        }
    }
}

# (1) Install Visual C++ 2015-2022 x64 Redistributable FIRST (unconditionally - upgrades stale runtime, no-ops if current)
$vcPath = Join-Path $stage 'vc_redist.x64.exe'
Get-RemoteFile -Url 'https://aka.ms/vs/17/release/vc_redist.x64.exe' -OutFile $vcPath -TimeoutSec 300
...
if ($vc.ExitCode -notin 0,3010,1638) { throw "VC++ redist install failed: $($vc.ExitCode)" }
Write-Output "VC++ redist installed (exit $($vc.ExitCode))"

# (2) Download the MariaDB MSI (large ~87MB, slow CDN - allow up to ~15 min)
$msiPath = Join-Path $stage 'mariadb-11.4.13-winx64.msi'
Get-RemoteFile -Url 'https://downloads.mariadb.org/rest-api/mariadb/11.4.13/mariadb-11.4.13-winx64.msi' -OutFile $msiPath -TimeoutSec 1200

# (3) Silent install of MariaDB
$svcName = 'MariaDB'
$existing = Get-Service -Name $svcName -ErrorAction SilentlyContinue
if (-not $existing) {
    $logPath = 'C:\Temp\mariadb-install.log'
    Write-Output "installing MariaDB 11.4.13 silently"
    $msiArgs = @(
        '/i', "`"$msiPath`"",
        '/qn',
        '/L*v', "`"$logPath`"",
    ...
    if ($p.ExitCode -notin 0,3010) {
        ...
        if (Test-Path $logPath) {
            ...
            $decisive = Get-Content $logPath | Select-String -Pattern 'Return value 3','Installation success or error status','2711','note: 1:'
            $decisive | ForEach-Object { Write-Output $_.Line }
        }
...
if ($svc.Status -ne 'Running') {
    Write-Output "starting MariaDB service"
    Start-Service -Name $svcName
}
$svc.Refresh()
if ((Get-Service -Name $svcName).Status -ne 'Running') { throw "MariaDB service failed to start" }
Write-Output "MariaDB service is Running (Automatic startup)"

# Add an explicit firewall rule for clarity (MSI also creates a program rule)
if (-not (Get-NetFirewallRule -DisplayName 'MariaDB 3306' -ErrorAction SilentlyContinue)) {
    ...
    Write-Output "created firewall rule: MariaDB 3306 (TCP inbound)"
}
...
while ((Get-Date) -lt $deadline) {
    if (Test-NetConnection -ComputerName 127.0.0.1 -Port 3306 -WarningAction SilentlyContinue -InformationLevel Quiet) { $listening = $true; break }
    Start-Sleep -Seconds 3
}
if (-not $listening) { throw "MariaDB is not listening on port 3306" }
Write-Output "MariaDB is listening on port 3306"

# Append connection details to the credentials file (never overwrite the scaffold document)
...
Add-Content -Path 'C:\credentials.txt' -Value "  User      : root (remote root@'%' enabled)"
Add-Content -Path 'C:\credentials.txt' -Value "  Password  : (see 'Mariadb Root Password' above)"
Add-Content -Path 'C:\credentials.txt' -Value "  Connect   : mysql -h $ipInfo -P 3306 -u root -p"

# Clean up the staging directory
Remove-Item -Recurse -Force $stage -ErrorAction SilentlyContinue
Write-Output "MariaDB deployment complete"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
