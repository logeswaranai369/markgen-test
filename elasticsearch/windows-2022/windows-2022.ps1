...
Write-Stage "install: Elasticsearch (single-node) on win2022"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
$staging = 'C:\Temp\es-install'
$zipPath = Join-Path $staging "elasticsearch-$esVersion-windows-x86_64.zip"
...
if (-not (Test-Path $esHome)) {
    Write-Output "downloading Elasticsearch $esVersion ..."
    $attempt = 0
    $ok = $false
    ...
    if (-not $ok) { throw "failed to download Elasticsearch after $attempt attempts" }
    ...
    if (-not (Test-Path $esHome)) { throw "extraction did not produce $esHome" }
} else {
    Write-Output "Elasticsearch already extracted at $esHome"
}

# Set ES_HOME / ES_PATH_CONF at machine scope AND in-session so the SYSTEM service inherits them.
...
# Configure elasticsearch.yml for a deterministic single-node plain-HTTP + basic-auth setup.
...
Write-Output "wrote elasticsearch.yml"

# Fix heap at 2g on the 8GB box via jvm.options.d
$jvmDir = Join-Path $esConf 'jvm.options.d'
New-Item -ItemType Directory -Force -Path $jvmDir | Out-Null
[System.IO.File]::WriteAllText((Join-Path $jvmDir 'heap.options'), "-Xms2g`n-Xmx2g`n")
Write-Output "wrote heap.options (2g)"
...
# Create the keystore and seed bootstrap.password BEFORE first start -> becomes the elastic user's
# initial password on fresh .security bootstrap. Neutralize native stderr so a warning can't abort.
$keystoreFile = Join-Path $esConf 'elasticsearch.keystore'
$savedEAP = $ErrorActionPreference
$ErrorActionPreference = 'Continue'
try {
    if (-not (Test-Path $keystoreFile)) {
        Write-Output "creating keystore ..."
        & cmd.exe /c "`"$keystoreBat`" create" 2>&1 | ForEach-Object { Write-Host $_ }
        if ($LASTEXITCODE -ne 0) { throw "keystore create failed: $LASTEXITCODE" }
    }
    Write-Output "adding bootstrap.password ..."
    $tmpPw = Join-Path $staging 'bp.txt'
    [System.IO.File]::WriteAllText($tmpPw, $elastic_password)
    & cmd.exe /c "type `"$tmpPw`" | `"$keystoreBat`" add -x -f bootstrap.password" 2>&1 | ForEach-Object { Write-Host $_ }
    $rc = $LASTEXITCODE
    Remove-Item -Path $tmpPw -Force -ErrorAction SilentlyContinue
    if ($rc -ne 0) { throw "adding bootstrap.password failed: $rc" }
} finally {
    $ErrorActionPreference = $savedEAP
}

# Install the Windows service (Apache commons-daemon procrun, LocalSystem)
...
if (-not $existing) {
    ...
    $ErrorActionPreference = 'Continue'
    try {
        & cmd.exe /c "`"$serviceBat`" install" 2>&1 | ForEach-Object { Write-Host $_ }
        if ($LASTEXITCODE -ne 0) { throw "service install failed: $LASTEXITCODE" }
    } finally {
        $ErrorActionPreference = $savedEAP
    }
} else {
    Write-Output "service $svcName already exists"
}
...
if (-not (Get-NetFirewallRule -DisplayName 'Elasticsearch 9200' -ErrorAction SilentlyContinue)) {
    ...
    Write-Output "opened firewall for TCP 9200"
}

# Wait for the service to be Running and port 9200 to listen (non-CIM probe, bounded).
$deadline = (Get-Date).AddMinutes(6)
$ready = $false
while ((Get-Date) -lt $deadline) {
    $svc = Get-Service -Name $svcName -ErrorAction SilentlyContinue
    if ($svc -and $svc.Status -eq 'Running') {
        if (Test-NetConnection -ComputerName 127.0.0.1 -Port 9200 -WarningAction SilentlyContinue -InformationLevel Quiet) {
            $ready = $true
            break
        }
    }
...
if (-not $ready) { throw "Elasticsearch did not reach Running + listening on 9200 in time" }
Write-Output "Elasticsearch service is Running and listening on 9200"

# Append connection details to the scaffold-owned credentials file (never overwrite it).
...
Add-Content -Path 'C:\credentials.txt' -Value ""
Add-Content -Path 'C:\credentials.txt' -Value "Elasticsearch endpoint : http://$($ip):9200/"
Add-Content -Path 'C:\credentials.txt' -Value "Elasticsearch user     : elastic (password = see 'Elastic Password' above)"

# Clean up staging (installers/archives must not ship in the image).
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
