...
Write-Stage "install: Elasticsearch (single-node) on win2019"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
if (-not $mgSecretFilesInit.ContainsKey('C:\credentials.txt')) {
    $mgCredHeader = @(
        "==================================================================",
        "  Elasticsearch (single-node) - deployment credentials",
...
Set-Status 'Installing Elasticsearch (single-node) and dependencies (this can take a few minutes)...'

# ----- BEGIN app-specific tasks (LLM-generated from AppSpec) -----
$esVersion = '9.5.3'
$esRoot = 'C:\Elasticsearch'
$esHome = Join-Path $esRoot "elasticsearch-$esVersion"
$stage = 'C:\Temp\es-stage'
$zipUrl = "https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-$esVersion-windows-x86_64.zip"
$serviceName = 'elasticsearch'

# --- Download + extract Elasticsearch (bundled OpenJDK) ---
if (-not (Test-Path (Join-Path $esHome 'bin\elasticsearch-service.bat'))) {
    ...
    $zipPath = Join-Path $stage "elasticsearch-$esVersion.zip"
    $ok = $false
    for ($i = 1; $i -le 4 -and -not $ok; $i++) {
        try {
            Write-Output "Downloading Elasticsearch $esVersion (attempt $i)..."
    ...
    if (-not $ok) { throw "Failed to download Elasticsearch from $zipUrl" }
    Write-Output "Extracting to $esRoot ..."
    Expand-Archive -Path $zipPath -DestinationPath $esRoot -Force
} else {
    Write-Output "Elasticsearch already extracted at $esHome"
}
if (-not (Test-Path (Join-Path $esHome 'bin\elasticsearch-service.bat'))) {
    throw "Elasticsearch payload missing at $esHome after extract"
}

# --- Write elasticsearch.yml (single-node, security on, HTTP TLS off) - NO BOM ---
$ymlPath = Join-Path $esHome 'config\elasticsearch.yml'
$yml = @'
cluster.name: markgen-es
node.name: node-1
...
'@
[System.IO.File]::WriteAllText($ymlPath, $yml, [System.Text.Encoding]::ASCII)
Write-Output "Wrote $ymlPath"

# --- Write JVM heap options ---
$jvmDir = Join-Path $esHome 'config\jvm.options.d'
New-Item -ItemType Directory -Force -Path $jvmDir | Out-Null
$heapPath = Join-Path $jvmDir 'heap.options'
$heap = "-Xms2g`n-Xmx2g`n"
[System.IO.File]::WriteAllText($heapPath, $heap, [System.Text.Encoding]::ASCII)
Write-Output "Wrote $heapPath"

# --- Seed the elastic password via keystore bootstrap.password BEFORE first start ---
$keystoreBat = Join-Path $esHome 'bin\elasticsearch-keystore.bat'
$keystoreFile = Join-Path $esHome 'config\elasticsearch.keystore'
$env:ES_HOME = $esHome
$env:ES_PATH_CONF = Join-Path $esHome 'config'
...
try {
    if (-not (Test-Path $keystoreFile)) {
        ...
        & $keystoreBat create -s 2>&1 | ForEach-Object { Write-Host $_ }
        if ($LASTEXITCODE -ne 0) { throw "elasticsearch-keystore create failed (exit $LASTEXITCODE)" }
    }
    # Feed bootstrap.password from stdin (-x reads value from stdin, -f overwrites)
    $tmpPw = Join-Path $env:TEMP 'es_bp.txt'
    [System.IO.File]::WriteAllText($tmpPw, $elastic_password, [System.Text.Encoding]::ASCII)
    Write-Output "Setting keystore bootstrap.password..."
    Get-Content $tmpPw | & $keystoreBat add -x -f 'bootstrap.password' 2>&1 | ForEach-Object { Write-Host $_ }
    $addRc = $LASTEXITCODE
    Remove-Item -Path $tmpPw -Force -ErrorAction SilentlyContinue
    if ($addRc -ne 0) { throw "elasticsearch-keystore add bootstrap.password failed (exit $addRc)" }
} finally {
...
if (-not $svc) {
    Write-Output "Installing Elasticsearch Windows service '$serviceName'..."
    $serviceBat = Join-Path $esHome 'bin\elasticsearch-service.bat'
    $prevEAP2 = $ErrorActionPreference
    $ErrorActionPreference = 'Continue'
    try {
        & $serviceBat install $serviceName 2>&1 | ForEach-Object { Write-Host $_ }
        $instRc = $LASTEXITCODE
    } finally {
        $ErrorActionPreference = $prevEAP2
    }
    if ($instRc -ne 0) { throw "elasticsearch-service install failed (exit $instRc)" }
} else {
    Write-Output "Elasticsearch service already installed."
}

$svc = Get-Service -Name $serviceName -ErrorAction SilentlyContinue
if (-not $svc) { throw "Elasticsearch service '$serviceName' was not registered." }
...
if ((Get-Service -Name $serviceName).Status -ne 'Running') {
    throw "Elasticsearch service '$serviceName' failed to reach Running state."
}
Write-Output "Elasticsearch service is Running."

# --- Wait for TCP 9200 to accept connections (socket probe, no CIM/WMI) ---
...
if (-not $listening) { throw "Elasticsearch is not listening on TCP 9200 within timeout." }
Write-Output "Elasticsearch is listening on TCP 9200."
...
Add-Content -Path 'C:\credentials.txt' -Value "NOTE: Security is ON, HTTP TLS is disabled (basic auth over HTTP). To enable HTTPS later, re-enable xpack.security.http.ssl and configure a certificate."
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
