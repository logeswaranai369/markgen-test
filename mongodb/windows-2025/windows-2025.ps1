...
Write-Stage "install: MongoDB Community Server 8.0 + mongosh on win2025"
...
[System.IO.File]::WriteAllBytes(
    $notifyPath,
    [System.Convert]::FromBase64String('')
)
...
if (-not $mgSecretFilesInit.ContainsKey('C:\credentials.txt')) {
    $mgCredHeader = @(
        "==================================================================",
        "  MongoDB Community Server 8.0 + mongosh - deployment credentials",
...
Set-Status 'Installing MongoDB Community Server 8.0 + mongosh and dependencies (this can take a few minutes)...'
...
function Get-File {
    ...
    while ($true) {
        $attempts++
        try {
            Write-Output "downloading $Url (attempt $attempts)"
            ...
            if ($attempts -ge 4) { throw "failed to download ${Url}: $($_.Exception.Message)" }
...
# ---------------------------------------------------------------------------
# 1) Install MongoDB Community Server 8.0 (server + service only, no Compass)
# ---------------------------------------------------------------------------
if (-not (Test-Path $mongodExe)) {
    $serverMsi = Join-Path $staging 'mongodb-server-8.0.29.msi'
    Get-File -Url 'https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-8.0.29-signed.msi' -OutFile $serverMsi

    $serverLog = Join-Path $staging 'mongodb-server-install.log'
    Write-Output "installing MongoDB Community Server 8.0.29 ..."
    ...
    if ($p.ExitCode -notin 0, 3010) {
        Write-Output "MongoDB server MSI failed with exit code $($p.ExitCode); dumping log tail:"
        if (Test-Path $serverLog) {
            Get-Content $serverLog | Select-String -Pattern 'Return value 3', 'Installation success or error status', '2711', 'note: 1:' | ForEach-Object { Write-Output $_.Line }
        }
        throw "MongoDB server install failed (exit $($p.ExitCode))"
    }
    Write-Output "MongoDB server installed"
} else {
    Write-Output "MongoDB server already installed"
}

if (-not (Test-Path $mongodExe)) { throw "mongod.exe not found at $mongodExe after install" }

# ---------------------------------------------------------------------------
# 2) Install mongosh (force machine-wide + fixed flat install path)
# ---------------------------------------------------------------------------
if (-not (Test-Path $mongoshExe)) {
    $mongoshMsi = Join-Path $staging 'mongosh-2.10.0.msi'
    Get-File -Url 'https://downloads.mongodb.com/compass/mongosh-2.10.0-x64.msi' -OutFile $mongoshMsi

    $mongoshLog = Join-Path $staging 'mongosh-install.log'
    Write-Output "installing mongosh 2.10.0 ..."
    $p = Start-Process msiexec.exe -Wait -PassThru -ArgumentList @(
        '/i', "`"$mongoshMsi`"",
        '/qn', '/norestart',
        'ALLUSERS=1',
        'INSTALLFOLDER="C:\Program Files\mongosh"',
        '/l*v', "`"$mongoshLog`""
    )
    if ($p.ExitCode -notin 0, 3010) {
        Write-Output "mongosh MSI failed with exit code $($p.ExitCode); dumping log tail:"
        if (Test-Path $mongoshLog) {
            Get-Content $mongoshLog | Select-String -Pattern 'Return value 3', 'Installation success or error status', '2711', 'note: 1:' | ForEach-Object { Write-Output $_.Line }
        }
        throw "mongosh install failed (exit $($p.ExitCode))"
    }
    Write-Output "mongosh installed"
} else {
    Write-Output "mongosh already installed"
}

if (-not (Test-Path $mongoshExe)) { throw "mongosh.exe not found at $mongoshExe after install" }

# ---------------------------------------------------------------------------
# 3) Ensure the service is running WITHOUT auth (localhost exception window)
#    so we can create the root admin user before enabling authorization.
# ---------------------------------------------------------------------------
Set-Service MongoDB -StartupType Automatic
if ((Get-Service MongoDB).Status -ne 'Running') { Start-Service MongoDB }

Write-Output "waiting for mongod to accept connections on 127.0.0.1:27017 ..."
$ready = $false
for ($i = 0; $i -lt 60; $i++) {
    try {
        $c = Test-NetConnection -ComputerName '127.0.0.1' -Port 27017 -WarningAction SilentlyContinue
        if ($c.TcpTestSucceeded) { $ready = $true; break }
    } catch {}
...
# ---------------------------------------------------------------------------
# 4) Create the root admin user via the localhost exception (auth not yet on)
# ---------------------------------------------------------------------------
Write-Output "creating root admin user 'mongoadmin' ..."
$createJs = "if (db.getSiblingDB('admin').getUser('mongoadmin') == null) { db.getSiblingDB('admin').createUser({ user: 'mongoadmin', pwd: '$mongodb_admin_password', roles: [ { role: 'root', db: 'admin' } ] }); print('created'); } else { print('exists'); }"

$prev = $ErrorActionPreference
$ErrorActionPreference = 'Continue'
& $mongoshExe --host 127.0.0.1 --port 27017 --quiet --eval $createJs 2>&1 | ForEach-Object { Write-Output $_ }
$code = $LASTEXITCODE
$ErrorActionPreference = $prev
if ($code -ne 0) { throw "failed to create admin user (mongosh exit $code)" }
Write-Output "admin user ensured"

# ---------------------------------------------------------------------------
# 5) Write authoritative mongod.cfg (bind all, enable auth) and restart
# ---------------------------------------------------------------------------
...
Write-Output "wrote mongod.cfg with bindIp 0.0.0.0 and authorization enabled"

Restart-Service MongoDB
Set-Service MongoDB -StartupType Automatic

Write-Output "waiting for mongod to accept connections after enabling auth ..."
$ready = $false
for ($i = 0; $i -lt 60; $i++) {
    try {
        $c = Test-NetConnection -ComputerName '127.0.0.1' -Port 27017 -WarningAction SilentlyContinue
...
if (-not $ready) { throw "mongod did not come back up after enabling auth" }

# ---------------------------------------------------------------------------
# 6) Open firewall for TCP 27017
# ---------------------------------------------------------------------------
if (-not (Get-NetFirewallRule -DisplayName 'MongoDB (TCP 27017)' -ErrorAction SilentlyContinue)) {
    New-NetFirewallRule -DisplayName 'MongoDB (TCP 27017)' -Direction Inbound -Protocol TCP -LocalPort 27017 -Action Allow | Out-Null
    Write-Output "opened inbound firewall rule for TCP 27017"
} else {
    Write-Output "firewall rule for TCP 27017 already exists"
}

# ---------------------------------------------------------------------------
# 7) Append connection info to the credentials file (never overwrite it)
# ---------------------------------------------------------------------------
...
Add-Content -Path 'C:\credentials.txt' -Value ""
Add-Content -Path 'C:\credentials.txt' -Value "--- MongoDB Connection ---"
Add-Content -Path 'C:\credentials.txt' -Value "Admin Username : mongoadmin"
Add-Content -Path 'C:\credentials.txt' -Value "Connection String : mongodb://mongoadmin@${hostIp}:27017/?authSource=admin (password: see 'Mongodb Admin Password' above)"

# ---------------------------------------------------------------------------
# 8) Clean up staged installers
# ---------------------------------------------------------------------------
Remove-Item -Recurse -Force $staging -ErrorAction SilentlyContinue
Write-Output "MongoDB Community Server 8.0.29 + mongosh deployment complete"
...
[System.IO.File]::WriteAllBytes(
    $cleanupPath,
    [System.Convert]::FromBase64String('')
)
